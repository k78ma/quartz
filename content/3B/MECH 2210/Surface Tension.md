...
![[Pasted image 20250219130733.png]]
...
A tensile force may be considered to be acting in the plane of the surface along any line in the surface. The intensity of the molecular attraction per unit length along any line in the surface is called the surface tension and is designated by the Greek symbol $\sigma$ with units of
$$
\sigma \equiv \frac{F}{L} \quad \left[ \frac{\text{N}}{\text{m}} \right]
$$
...
$$
\Delta p\pi R^{2}=\sigma\cdot 2\pi R
$$
or
$$
\Delta p=p_{i}-p_{e}=\frac{2\sigma}{R}
$$
such that $\Delta p\propto \frac{\sigma}{R}$.


![[Surface Tension.png|571]]
