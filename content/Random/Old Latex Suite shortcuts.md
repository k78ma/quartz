...
[    
    ...
    {trigger: "pm", replacement: "\\pm $0", options: "mA"},
    {trigger: "to", replacement: ", \\dots, $0", options: "m"},
    {trigger: "dm", replacement: "$$\n$0\n$$", options: "tAw"},
    {trigger: "sig", replacement: "\\text{sig}[$0]", options: "m"},
    {trigger: "beg", replacement: "\\begin{$0}\n$1\n\\end{$0}", options: "mA"},
    {trigger: "dim", replacement: "\\dim  $0", options: "mA"},
    {trigger: "pargmin", replacement: "\\underset{${0:\\phi}}{\\operatorname{argmin}}", options: "mA"},
    {trigger: "pmin", replacement: "\\underset{${0:\\phi}}{\\operatorname{min}}", options: "mA"},

        {trigger: "tdeg", replacement: "\\deg  $0", options: "mA"},
    {trigger: "pargmax", replacement: "\\underset{${0:\\phi}}{\\operatorname{argmax}}", options: "mA"},
    {trigger: "pmax", replacement: "\\underset{${0:\\phi}}{\\operatorname{max}}", options: "mA"},
    {trigger: "argmin", replacement: "{\\operatorname{argmin}}", options: "mA"},
    {trigger: "ast", replacement: "\\ast  $0", options: "mA"},
    {trigger: "argmax", replacement: "{\\operatorname{argmax}}", options: "mA"},
    {trigger: "foral", replacement: "\\,\\, \\forall \\, $0", options: "mA"},
    {trigger: "quad", replacement: "\\quad $0", options: "mA"},
    {trigger: "ceil", replacement: "\\lceil $0 \\rceil", options:"mA"},
    {trigger: "box", replacement: "\\boxed{ $0 }", options:"m"},
    {trigger: "floor", replacement: "\\lfloor $0 \\rfloor", options:"mA"},
    {trigger: "f;", replacement: "\lceil $0 \rceil", options:"m"},
    {trigger: "ii", replacement: "_{i$0}", options:"m"},
  //  {trigger: "nn", replacement: "_{n$0}", options:"m"},
    {trigger: "andt", replacement: "\\quad \\text{and} \\quad $0", options:"m"},
    {trigger: "ort", replacement: "\\quad \\text{or} \\quad $0", options:"m"},
    {trigger: "sci", replacement: "\\times 10^{$0}", options:"mA"},
    {trigger: "ke", replacement: "\\text{KE}$0", options:"m"},
    {trigger: "pe", replacement: "\\text{PE}$0", options:"m"},
    {trigger: "volt", replacement: "\\text{ V}", options:"mA"},
    {trigger: "vt", replacement: "V_{\\text{$0}}", options:"m"},
    {trigger: "amp", replacement: "\\text{ A}", options:"mA"},
    {trigger: "ohm", replacement: "\\text{ }\\Omega", options:"mA"},
    {trigger: "angle", replacement: "\\angle $0", options:"mA"},
    {trigger: "([a-zA-Z])ohm", replacement: "\\text{ [[0]]} \\Omega", options:"rmA"},
    {trigger: "([a-zA-Z])volt", replacement: "\\text{ [[0]]V}", options:"rmA"},
    {trigger: "([a-zA-Z])amp", replacement: "\\text{ [[0]]A}", options:"rmA"},
    {trigger: "span", replacement: "\\text{span}($0)", options:"rmA"},
    {trigger: "brc", replacement: "\\{ $0 \\}", options:"rmA"},
    {trigger: "in", replacement: "\\in  $0", options:"m"},
{trigger: "nin", replacement: "\\notin  $0", options:"m"},
    {trigger: "mps", replacement: "\\text{ m/s}", options: "m"},
    {trigger: "mps2", replacement: "\\text{ m/s}^2", options: "mA"},
    ...
    // Therefore
    {trigger: "tfr", replacement: "\\therefore $0", options: "mA"},

    // Time parameter
    {trigger: "tprm", replacement: "t_{\\text{$0}}", options: "mA"},

    // Fraction newline spacing
    {trigger: "frs", replacement: "\\\\[2ex] \n", options: "mA"},
    {trigger: "frc", replacement: "[2ex]", options: "mA"},
    ...
    {trigger: "sbf", replacement: "\\boldsymbol{$0}", options: "mA"},
    ...
    {trigger: "gv", replacement: "\\, | \\,", options: "mA"},
    ...
    {trigger: "rre", replacement: "\\mathrm{Re}", options: "mA"},
    ...
    {trigger: "\\\\(arcsin|arccos|arctan|arccot|arccsc|arcsec|sin|cos|tan|cot|csc|sum|in)([A-Za-gi-z])", replacement: "\\[[0]] [[1]]", options: "rmA"}, // Insert space after trig funcs. Skips letter "h" to allow sinh, cosh, etc.
    ...
    {trigger: "\\\\(arcsin|arccos|arctan|arccot|arccsc|arcsec|sin|cos|tan|cot|csc|sum)([0-9]+)", replacement: "\\[[0]] [[1]]", options: "rmA"}, // Insert space after trig funcs. Skips letter "h" to allow sinh, cosh, etc.
    {trigger: "\\\\(arcsinh|arccosh|arctanh|arccoth|arcsch|arcsech|sinh|cosh|tanh|coth|csch)([0-9]+)", replacement: "\\[[0]] [[1]]", options: "rmA"}, // Insert space after trig funcs

    {trigger: "\\\\(neq|geq|leq|sim|to|->|approx|angle|times)([0-9]+)", replacement: "\\[[0]] [[1]]", options: "rmA"}, // Insert space after inequality symbols
    ...
    {trigger: "etc", replacement: "\\dots", options: "mA"},
    {trigger: "<->", replacement: "\\leftrightarrow ", options: "mA"},
    {trigger: "->", replacement: "\\to", options: "mA"},
    {trigger: "<-", replacement: "\\leftarrow", options: "mA"},
    {trigger: "slra", replacement: "\\quad \\longrightarrow \\quad $0", options: "mA"},
    {trigger: "sLra", replacement: "\\quad \\Longrightarrow \\quad $0", options: "mA"},
        {trigger: "slla", replacement: "\\quad \\longleftarrow \\quad $0", options: "mA"},
    {trigger: "sLla", replacement: "\\quad \\Longleftarrow \\quad $0", options: "mA"},
    {trigger: "ste", replacement: "\\quad \\text{$0}", options: "mA"},
    {trigger: "lra", replacement: "\\longrightarrow", options: "mA"},
    {trigger: "to", replacement: "\\to", options: "m"},
    {trigger: "!>", replacement: "\\mapsto", options: "mA"},
    {trigger: "invs", replacement: "^{-1}", options: "mA"},
    {trigger: "mset", replacement: "\\setminus", options: "mA"},
    {trigger: "||", replacement: "\\mid", options: "mA"},
    // {trigger: "abs", replacement: "| $0 |", options:"mA"},
    {trigger: "mag", replacement: "|| $0 ||", options:"mA"},
    {trigger: "and", replacement: "\\cap", options: "mA"},
    {trigger: "orr", replacement: "\\cup", options: "mA"},
    {trigger: "inn", replacement: "\\in", options: "mA"},
    {trigger: "subs", replacement: "\\subset $0", options: "mA"},
    {trigger: "subseq", replacement: "\\subseteq $0", options: "mA"},
    ...
    {trigger: "\\nu \\ll", replacement: "\\text{null }  $0", options: "m", priority: 1},
    {trigger: "range", replacement: "\\text{range }  $0", options: "m"},
    ...
    {trigger: "..,", replacement: "\\bullet ", options: "mA"},
    {trigger: "para", replacement: "\\parallel", options: "mA"},


    {trigger: "nn", replacement: "_{n$0}", options: "m"},
    {trigger: "\\xi ii", replacement: "x_{i}", options: "mA", priority: 1},
    {trigger: "\\xi n", replacement: "x \\in", options: "m", priority: 1},
    {trigger: "\\pi n", replacement: "p \\in", options: "m", priority: 1},
    ...
    //{trigger: "lll", replacement: "\\ell", options: "m"},
    {trigger: "LLL", replacement: "\\mathcal{L}", options: "mA"},
    {trigger: "FF", replacement: "\\mathbb{F}", options: "mA"},
    {trigger: "HH", replacement: "\\mathcal{H}", options: "mA"},
    {trigger: "CC", replacement: "\\mathbb{C}", options: "mA"},
    {trigger: "RR", replacement: "\\mathbb{R}", options: "mA"},
    {trigger: "LL", replacement: "\\mathcal{L}", options: "mA"},
    // {trigger: "rr", replacement: "\\mathcal{R}", options: "mA"},
    ...
    {trigger: "dol", replacement: "\\$ $0", options: "mA"},
    ...
    {trigger: "dsum", replacement: "\\sum_{${0:i}=${1:1}}^{${2:n}}", options: "mA"},
    {trigger: "choose", replacement: "{$0 \\choose $1}", options: "mA"},
    {trigger: "usum", replacement: "\\sum_{${0:i}}", options: "mA"},
    {trigger: "dprod", replacement: "\\prod_{${0:i}=${1:1}}^{${2:n}}", options: "mA"},
    ...
    {trigger: "hdm", replacement: "\\odot $0", options: "mA"},
    ...
    {trigger: "ce", replacement: "\\ce{ $0 }", options: "m"},
