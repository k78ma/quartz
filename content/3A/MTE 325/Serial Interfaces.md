...
The original file might be divided into packets, which often consist of a portion of the data itself as well as a **header**. The header might contain metadata information like who the receiver is and how many total packets there are, when it was generated, error detection/correction information.
