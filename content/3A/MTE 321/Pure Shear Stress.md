...
The shear strain ($\gamma$) is the change in right angle of stress element when subjected to pure shear stress.

![[Pure Shear Stress.png]]

Hooke's law for shear is then:
$$
\tau = G\gamma
$$
where $G$ is shear modulus of elasticity (or modulus of rigidity).
