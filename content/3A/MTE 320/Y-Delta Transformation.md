...
For balanced impedance loads, we have:
$$
\begin{align}
Z_{Y} & =\frac{1}{3}Z_{\Delta} \\[2ex] 
Z_{\Delta} & =3Z_{Y}
\end{align}
$$
This can be derived based on the fact that the Y-connected load and the corresponding $\Delta$-connected load are equivalent circuits.
