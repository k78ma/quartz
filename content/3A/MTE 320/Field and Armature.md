...
- **Lap Winding:** $P$ parallel paths in the armature winding between the DC machine terminals, where $P$ is the number of poles on the field or stator. This connection style is used in high-current applications. Note that the current rating of the machine will be $P$ times that of the conductors used for armature winding
