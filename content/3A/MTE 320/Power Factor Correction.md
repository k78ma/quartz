...
---
Power factor correction is the effort made to improve the [[Power Factor|power factor]] at the interface of the load with the power supply. 
...
Here, the loads is usually inductive – they have a lagging power factor, such that they draw reactive power together with [[Average Power|active power]]. 
- If all or part of the [[Reactive Power|reactive power]] required by the load is produced locally (i.e., at the interface of the load with the supply), there is no/less need for reactive power to be supplied by the source.
