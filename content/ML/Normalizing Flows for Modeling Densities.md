...
---
Normalizing flows is capable of computing the exact log-likelihood of a new sample, unlike [[GANs]], [[VAE Summary|VAEs]], and [[Diffusion Models]]. GANs are not probabilistic, and both VAEs and diffusion models can only return a lower bound on the likelihood.
