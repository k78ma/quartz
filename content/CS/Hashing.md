...
aliases:
  - hash function
---
Hashing is a practical way of maintaining a [[Dictionary|dictionary]], taking advantage of the fact that looking an item up in an array takes constant time once you have its index.
## Hash Function
