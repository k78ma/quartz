...
- Thank you for making the time to chat, I know the internship is still a while away; I'm very excited and had a couple questions about technical skills, a couple questions about the team, and one thing I need to give you a heads up about.

- I already asked about technology I should get familiar with – you answered radar, which is helpful. I wanted to get a bit more specific in terms of development tools; for example, I know for languages you use C++ and Python, do I need to know CI/CD stuff, infrastructure, any specific NVIDIA stuff like CUDA?

- Questions about the team
	- Team size?
	- My impression from the job posting and from our previous chat is that everyone mostly remote?
		- My main concern here is to make sure I'm learning as much as possible, and I want to make sure that being remote doesn't affect this.
	- Is there a mentorship system where I get assigned a mentor?
	
- Work hours – Is it just 9-5 or relatively flexible?
- Meetings – every day?

- AOJ – 5 responsibilities and 5 skills
- One last thing I wanted to let you know about – I have to "register" the internship with my school to get a credit for it. I basically just have to paste the job description into a form, and give some details on job responsibilities and what skills I'm learning. Once I've filled out the form, they're going to send it to the employer (in this case, you) to confirm. I'll do that next month once I'm back at school, and then I'll shoot you an email to let you know.

You need to include a minimum of 5 responsibilities and 5 skills that you will gain.
